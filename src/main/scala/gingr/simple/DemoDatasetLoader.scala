...
trait DataSetLoader {
  ...
  def defaultTargetOffset: TranslationAfterRotation[_3D] = TranslationAfterRotationSpace3D(
    Point(0, 0, 0)
  ...
  def modelGauss(
      ...
      sigma: Double = defaultGaussSigma
  ): (PointDistributionModel[_3D, TriangleMesh], Option[Seq[Landmark[_3D]]]) = {
  ...
  def modelInvLap(
      decimate: Option[Int] = None,
      fullResolutionReturn: Boolean = true,
      scaling: Double = defaultInvLapScaling
  ): (PointDistributionModel[_3D, TriangleMesh], Option[Seq[Landmark[_3D]]]) = {
  ...
  def modelInvLapDot(
      ...
      gamma: Double = defaultInvLapDotGamma
  ): (PointDistributionModel[_3D, TriangleMesh], Option[Seq[Landmark[_3D]]]) = {
...
object DemoDatasetLoader {
  ...
  case object femur extends DataSetLoader {
    ...
    override def target(
        offset: TranslationAfterRotation[_3D] = defaultTargetOffset
